                ...
                success: function (b) {
                    ...
                    b.data.status && "1" == b.data.status
                        ? ((d = b.data.regeocode),
                            ...
                            e.streetNumber &&
                                e.streetNumber.street &&
                                e.streetNumber.number
                                ? (f.push(e.streetNumber.street),
                                    f.push(e.streetNumber.number))
                                : ((k = ""),
                                    d &&
                                    d.roads[0] &&
                                    d.roads[0].name &&
                            ...
                            if (((b = b.data), b && b.pois)) {
                                for (c = [], d = 0; d < b.pois.length; d++)
                                    (e = 0 == d ? a.iconPathSelected : a.iconPath),
                                        c.push({
                                            latitude: parseFloat(
                                                b.pois[d].location.split(",")[1]
                                            ),
                                            longitude: parseFloat(
                                                b.pois[d].location.split(",")[0]
                                            ),
                                            iconPath: e,
                                            width: 22,
                                            height: 32,
            ...
            wx.request({
                ...
                success: function (b) {
                    b &&
                        b.data &&
                        b.data.data &&
                        a.success({ paths: b.data.data.paths });
                },
                fail: function (b) {
                    a.fail({ errCode: "0", errMsg: b.errMsg || "" });
                }
