...
const msg = {
    ...
    idcard: { required: "请输入身份证号码", idcard: "请输入正确的身份证号码" },
    number: { required: "请输入有效的数字", number: "请输入正确的数字" },
    date: { required: "请选择日期", date: "请选择日期" },
    digits: { required: "请输入整数", date: "请输入正确的整数" },
}
const rule = {
